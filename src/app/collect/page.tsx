...
export default function CollectPage() {
  ...
  const validate = (): boolean => {
    ...
    if (missing.length > 0) {
      ...
      setErrors(missing.map(f=>labels[f]||f))
      return false
    }
    return true
  }
  ...
  // 姓名转拼音 (simple mapping: first char = surname, rest = given name)
  const toPinyin = () => {
    if (!form.name) return
    // Common Chinese surname pinyin mapping (top surnames)
    const surnames: Record<string,string> = {
      ...
      '许':'Xu','何':'He','吕':'Lv','施':'Shi','张':'Zhang','孔':'Kong','曹':'Cao','严':'Yan',
      '金':'Jin','魏':'Wei','陶':'Tao','姜':'Jiang','谢':'Xie','邹':'Zou','苏':'Su','潘':'Pan',
      '葛':'Ge','范':'Fan','彭':'Peng','鲁':'Lu','韦':'Wei','马':'Ma','苗':'Miao','方':'Fang',
      '俞':'Yu','任':'Ren','袁':'Yan','柳':'Liu','唐':'Tang','罗':'Luo','薛':'Xue','贺':'He',
      '倪':'Ni','汤':'Tang','殷':'Yin','毕':'Bi','郝':'Hao','安':'An','常':'Chang','于':'Yu',
      '傅':'Fu','齐':'Qi','康':'Kang','余':'Yu','元':'Yuan','顾':'Gu','孟':'Meng','黄':'Huang',
      '穆':'Mu','萧':'Xiao','尹':'Yin','姚':'Yao','邵':'Shao','汪':'Wang','祁':'Qi','毛':'Mao',
      '禹':'Yu','米':'Mi','贝':'Bei','明':'Mang','计':'Ji','成':'Cheng','戴':'Dai','宋':'Song',
      '庞':'Pang','熊':'Xiong','纪':'Ji','舒':'Shu','屈':'Qu','项':'Xiang','祝':'Zhu','董':'Dong',
      '梁':'Liang','杜':'Du','阮':'Ruan','蓝':'Lan','席':'Xi','季':'Ji','强':'Qiang','贾':'Jia',
      '路':'Lu','娄':'Lou','江':'Jiang','童':'Tong','颜':'Yan','郭':'Guo','梅':'Mei','林':'Lin',
      '钟':'Zhong','徐':'Xu','邱':'Qiu','高':'Gao','夏':'Xia','蔡':'Cai','田':'Tian','樊':'Fan',
      '胡':'Hu','凌':'Ling','万':'Wan','柯':'Ke','管':'Guan','卢':'Lu','莫':'Mo','房':'Fang',
      '干':'Gan','解':'Xie','应':'Ying','宗':'Zing','丁':'Ding','邓':'Deng','郁':'Yu','单':'Shan',
      '杭':'Hang','洪':'Hong','包':'Bao','诸':'Zhu','左':'Zuo','石':'Shi','崔':'Cui','吉':'Ji',
      '龚':'Gong','程':'Cheng','邢':'Xing','裴':'Pei','陆':'Lu','荣':'Rong','翁':'Weng','羊':'Yang',
      '惠':'Hui','甄':'Zhen','曲':'Qu','封':'Feng','芮':'Rui','靳':'Jin','段':'Duan','富':'Fu',
      '巫':'Wu','乌':'Wu','焦':'Jiao','巴':'Ba','弓':'Gong','牧':'Mu','山':'Shan','谷':'Gu',
      '车':'Che','侯':'Hou','全':'Quan','班':'Ban','仰':'Yang','秋':'Qiu','仲':'Zhong','伊':'Yi',
      '宫':'Gong','宁':'Ning','仇':'Qiu','栾':'Luan','甘':'Gan','厉':'Li','戎':'Rong','祖':'Zu',
      '武':'Wu','符':'Fu','刘':'Liu','景':'Jing','龙':'Long','叶':'Ye','司':'Si','黎':'Li',
      '白':'Bai','怀':'Huai','蒲':'Pu','从':'Cong','索':'Suo','赖':'Lai','卓':'Zhuo','蔺':'Lin',
      '屠':'Tu','蒙':'Meng','池':'Chu','乔':'Qiao','双':'Shuang','闻':'Wen','党':'Dang','翟':'Zhai',
      '谭':'Tan','贡':'Gong','劳':'Lao','姬':'Ji','申':'Shen','冉':'Ran','宰':'Zai','雍':'Yong',
      '桑':'Sang','桂':'Gui','濮':'Pu','牛':'Niu','寿':'Shou','通':'Tong','边':'Bian','燕':'Yan',
      '冀':'Ji','浦':'Pu','尚':'Shang','农':'Nong','温':'Wen','别':'Bie','庄':'Zhuang','晏':'Yan',
      '柴':'Chai','瞿':'Qu','阎':'Yan','充':'Chong','慕':'Mu','连':'Lian','茹':'Ru','习':'Xi',
      '艾':'Ai','鱼':'Yu','容':'Rong','向':'Xiang','古':'Gu','易':'Yi','慎':'Shen','戈':'Ge',
      '廖':'Liao','庾':'Yu','居':'Ju','衡':'Heng','步':'Bu','都':'Du','耿':'Geng','满':'Man',
      '弘':'Hong','匡':'Kuang','国':'Guo','文':'Wen','寇':'Kou','广':'Guang','禄':'Lu','东':'Dong',
      '欧':'Ou','沃':'Wo','利':'Li','蔚':'Yu','越':'Yue','隆':'Long','师':'Shi','巩':'Gong',
      '聂':'Nie','晁':'Chao','勾':'Gou','敖':'Ao','融':'Rong','冷':'Leng','辛':'Xin','那':'Na',
      '简':'Jin','饶':'Rao','空':'Kong','曾':'Zeng','母':'Mu','沙':'Sha','养':'Yang','鞠':'Ju',
      '须':'Xu','丰':'Feng','巢':'Chao','关':'Guan','相':'Xiang','查':'Cha','后':'Hou','荆':'Jing',
      '红':'Hong','游':'You','权':'Quan','盖':'Gai','益':'Yi','桓':'Huan','公':'Gong','仉':'Zhang',
      '督':'Du','晋':'Jin','楚':'Chu','闫':'Yan','法':'Fa','鄢':'Yan','涂':'Tu','钦':'Qin',
      '归':'Gui','海':'Hai','岳':'Yue','帅':'Shuai','亢':'Kang','况':'Kuang','有':'You','琴':'Qin',
      '商':'Shang','牟':'Mu','佘':'She','伯':'Bo','赏':'Shang','墨':'Mo','哈':'Ha','谯':'Qiao',
      '笪':'Da','年':'Nian','爱':'Ai','阳':'Yang','佟':'Tong','言':'Yan','福':'Fu','夏侯':'Xiahou',
      '东方':'Dongfang','皇甫':'Huangfu','尉迟':'Yuchi','公孙':'Gongsun','慕容':'Murong','长孙':'Zhangsun','宇文':'Yuwen','司徒':'Situ',
      '端木':'Duanmu','独孤':'Dugu',
      }
    const surname = form.name.charAt(0)
    const given = form.name.slice(1)
    const surnamePinyin = surnames[surname] || surname
    // Simple given name: just use the characters as-is (proper conversion needs a library)
    const pinyin = `${surnamePinyin} ${given}`
    up('namePinyin', pinyin)
  }

  // 拆分地址 - split full address into components
  const splitAddress = () => {
    if (!form.idAddress) return
    const addr = form.idAddress
    // Try to extract province, city, district, detail
    ...
    for (const prov of provinces) {
      if (rest.startsWith(prov)) {
        p = prov
        rest = rest.slice(prov.length).replace(/^(省|市|自治区|壮族自治区|回族自治区|维吾尔自治区)/,'')
        break
      }
    }
    // Try to find city
    const cityMatch = rest.match(/^(.{2,5}?)(市|地区|州|盟)/)
    if (cityMatch) {
      c = cityMatch[1] + cityMatch[2]
      rest = rest.slice(cityMatch[0].length)
    }
    // Try to find district
    const distMatch = rest.match(/^(.{2,5}?)(区|县|市|旗)/)
    if (distMatch) {
      d = distMatch[1] + distMatch[2]
    ...
    setForm(prev=>({
      ...
      detailedAddress: rest || prev.detailedAddress,
    }))
  }

  // 翻译地址 - translate Chinese address to English (simple approach)
  const translateAddress = () => {
    if (!form.idAddress) return
    // Simple pinyin-based translation for common address components
    const replacements: [RegExp,string][] = [
      [/省/g,' Province'],[/市/g,' City'],[/区/g,' District'],[/县/g,' County'],
      [/镇/g,' Town'],[/乡/g,' Township'],[/村/g,' Village'],[/路/g,' Road'],
      [/街/g,' Street'],[/巷/g,' Lane'],[/号/g,' No.'],[/楼/g,' Building'],
      [/室/g,' Room'],[/栋/g,' Building'],[/单元/g,' Unit'],
    ]
    let addr = form.idAddress
    for (const [re,rep] of replacements) addr = addr.replace(re, rep)
      ...
      <div className="bg-primary-500 text-white py-6">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-2">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center"><span className="text-primary-500 font-bold text-sm">德</span></div>
          ...
          <div className="flex gap-1 mb-5 overflow-x-auto pb-1">
            {tabs.map(t=>(
              <button key={t.id} type="button" onClick={()=>{setTab(t.id);setErrors([])}}
                className={`flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-all ${tab===t.id?'bg-primary-500 text-white shadow-sm':'bg-white text-gray-600 border border-gray-200 hover:bg-gray-50'}`}>
          ...
          <div className="flex items-center justify-between mt-5">
            ...
            {i < tabs.length-1 ? (
              <button type="button" onClick={next}
                className="px-5 py-2 bg-primary-500 text-white rounded-xl hover:bg-primary-600 text-sm font-medium">
                下一步 →
              </button>
            ) : (
              <button type="submit" disabled={submitting}
                className="px-6 py-2 bg-primary-500 text-white rounded-xl hover:bg-primary-600 disabled:opacity-50 text-sm font-semibold">
                {submitting?'提交中...':'提交'}
              </button>
            )}
          </div>
...
function L({children,r}:{children:React.ReactNode;r?:boolean}) {
  return <label className="block text-sm font-medium text-gray-700 mb-1">{r&&<span className="text-red-500 mr-0.5">*</span>}{children}</label>
}
function I({label,value,onChange,ph,type='text',disabled=false,r=false}:{
  ...
  return <div><L r={r}>{label}</L>
    <input type={type} value={value} onChange={e=>onChange(e.target.value)} placeholder={ph} disabled={disabled}
      className={`w-full px-3 py-2.5 rounded-xl border text-sm outline-none transition-all disabled:bg-gray-50 ${r&&!value.trim()?'border-red-300 focus:border-red-500':'border-gray-200 focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20'}`}/></div>
}
function Sel({label,value,onChange,options,r=false}:{label:string;value:string;onChange:(v:string)=>void;options:string[];r?:boolean}) {
  return <div><L r={r}>{label}</L>
    <select value={value} onChange={e=>onChange(e.target.value)}
      className={`w-full px-3 py-2.5 rounded-xl border text-sm outline-none ${r&&!value?'border-red-300':'border-gray-200'}`}>
...
function DateI({label,value,onChange,r=false}:{label:string;value:string;onChange:(v:string)=>void;r?:boolean}) {
  return <div><L r={r}>{label}</L>
    <input type="date" value={value} onChange={e=>onChange(e.target.value)}
      className={`w-full px-3 py-2.5 rounded-xl border text-sm outline-none ${r&&!value?'border-red-300':'border-gray-200'}`}/></div>
}
function Btn({children,onClick,cls=''}:{children:React.ReactNode;onClick:()=>void;cls?:string}) {
  return <button type="button" onClick={onClick}
    className={`px-3 py-1.5 rounded-lg text-xs font-medium border transition-all hover:shadow-sm ${cls||'bg-gray-50 text-gray-600 border-gray-200 hover:bg-gray-100'}`}>{children}</button>
}
  ...
  return <div><L>{label}</L>
    <div className="flex gap-2 mt-1">{options.map(o=>
      <button key={o} type="button" onClick={()=>onChange(o)}
        className={`px-3 py-1.5 rounded-lg text-sm border ${value===o?'bg-primary-500 text-white border-primary-500':'bg-white text-gray-600 border-gray-200'}`}>{o}</button>
    )}</div></div>
}
function FileUp({label,onChange,hint}:{label:string;onChange:(f:File|null)=>void;hint?:string}) {
  const [fname, setFname] = useState('')
  return <div>
    <L>{label}</L>
    <label className="flex items-center justify-center gap-2 px-3 py-2.5 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-primary-300 hover:bg-primary-50/30 transition-all">
      <span className="text-gray-400 text-lg">📎</span>
      <span className="text-sm text-gray-500">{fname||'点击上传附件'}</span>
...
function IdTab({form,up,files,handleFile,toPinyin,splitAddress,translateAddress}:{
  ...
  return <div className="space-y-5">
    ...
    {/* Row 1: ID number, issuer, DL dates */}
    ...
    {/* Row 2: birthday, ID validity, ethnicity */}
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
    ...
    {/* Row 3: name, gender, pinyin button */}
    ...
    {/* Row 4: country, address, zip, translate */}
    <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 items-end">
    ...
    {/* Row 5: province, city, district, detail */}
...
function VisaTab({form,up,files,handleFile}:{form:FormData;up:(k:keyof FormData,v:any)=>void;files:FileState;handleFile:(k:keyof FileState,f:File|null)=>void}) {
  return <div className="space-y-5">
    ...
    <FileUp label="签证照片" onChange={f=>handleFile('visaPhoto',f)} hint="上传签证页照片"/>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <I label="签证类型" value={form.visaType} onChange={v=>up('visaType',v)} ph="如 B1/B2"/>
      <I label="签证号码" value={form.visaNumber} onChange={v=>up('visaNumber',v)} ph="签证号码"/>
...
function PassportTab({form,up,files,handleFile}:{form:FormData;up:(k:keyof FormData,v:any)=>void;files:FileState;handleFile:(k:keyof FileState,f:File|null)=>void}) {
  return <div className="space-y-5">
    ...
    <FileUp label="护照" onChange={f=>handleFile('passport',f)} hint="上传护照信息页照片"/>
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
...
function OtherTab({form,up,toggleP,files,handleFile}:{form:FormData;up:(k:keyof FormData,v:any)=>void;toggleP:(p:string)=>void;files:FileState;handleFile:(k:keyof FileState,f:File|null)=>void}) {
  return <div className="space-y-5">
    ...
    <I label="Mailing Address 邮寄地址" value={form.mailingAddress} onChange={v=>up('mailingAddress',v)} ph="如果有美国地址填美国地址，无，请填国内邮寄地址" r/>
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
